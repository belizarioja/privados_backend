...
module.exports = {
    async login (usuario, clave) {
        ...
        const from = " from t_usuarios a, t_rol b ";
    ...
    async listarusuarios () {
        // const clavehash = crypto.createHash('md5').update(clave).digest("hex");
        const sql = "select a.co_usuario, a.tx_nombre, a.tx_usuario, a.tx_clave, a.co_rol, b.tx_rol, a.in_activa from t_usuarios a, t_rol b where a.co_rol = b.co_rol ";
        // console.log(sql);
